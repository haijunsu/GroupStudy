...
import com.navysu.java.basic.companies.spothero.Duration;
import com.navysu.java.basic.companies.spothero.DurationOverlap;
...
class DurationOverlapTest {
	...
	void testIsAnyOverlap() {
		...
		//anyOverlapping([(1,3), (5,7), (2,4), (6,8)]) would return true because (1,3) and (2,4) overlap
		...
		testCases.clear();
		//anyOverlapping([(1,3), (7,9), (4,6), (10,13)]) would return false because none overlap
